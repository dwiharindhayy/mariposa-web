...
<div class="container">
    ...
    <div class="btn-register d-flex gap-3">
        <div class="btn-google">
            <button class="d-flex gap-1">
                ...
                <p style="margin:0; font-size: 12px;">Sign Up With Google</p>
            </button>
        </div>
        ...
        <div class="btn-facebook">
            <button class="d-flex gap-1">
                ...
                <p style="margin:0; font-size: 12px;">Sign Up With Facebook</p>
            </button>
        </div>
    </div>
    ...
    <br>
    <div class="disclamer">
        <p>Already have an account? <a style="color:#EDBADC; text-decoration:none;" href="/login">Login</a></p>
    </div>
</div>
