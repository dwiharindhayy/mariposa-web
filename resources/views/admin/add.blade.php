...
<div class="container">
    <h1 class='fs-2 text mt-4'>Add Product</h1>
    <div class="form-add">
        <form action="/admin/product/add/post" method="post" enctype="multipart/form-data">
            @csrf
            <div class="mb-3 mt-4">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name='size' placeholder='XL, L, M, S'>
              <div id="emailHelp" class="form-text">Gunakan koma (,) untuk memisahkan size</div>
            </div>
            <div class="mb-3">
            ...
            <button class='btn-general-med mt-4' type="submit">Add Product</button>
